...
def network(net, labels):
   ...
   net = slim.layers.conv2d(net, 16, [5,5], scope='init_conv', normalizer_fn=slim.layers.batch_norm)

   net = slim.layers.conv2d(net, 16, [5,5], scope='conv_1_1', normalizer_fn=slim.layers.batch_norm)
   net = slim.layers.conv2d(net, 16, [5,5], scope='conv_1_2', normalizer_fn=slim.layers.batch_norm)
   ...
   net = slim.layers.conv2d(net, 32, [5,5], scope='conv_2_2', normalizer_fn=slim.layers.batch_norm)
   net = slim.layers.max_pool2d(net, [2,2], scope='pool_2')

   net = slim.layers.conv2d(net, 100, [5,5], scope='conv_3_1', normalizer_fn=slim.layers.batch_norm)
   net = slim.layers.conv2d(net, 100, [5,5], scope='conv_3_2', normalizer_fn=slim.layers.batch_norm)
   net = slim.layers.conv2d(net, 100, [5,5], scope='conv_3_3', normalizer_fn=slim.layers.batch_norm)
   net = slim.layers.conv2d(net, 100, [5,5], scope='conv_3_4', normalizer_fn=slim.layers.batch_norm)
   net = slim.layers.conv2d(net, 100, [5,5], scope='conv_3_5', normalizer_fn=slim.layers.batch_norm)
   net = slim.layers.conv2d(net, 100, [5,5], scope='conv_3_6', normalizer_fn=slim.layers.batch_norm)
