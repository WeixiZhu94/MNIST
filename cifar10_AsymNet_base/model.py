...
def network(images, labels):
   ...
   net = slim.layers.conv2d(images, 16, [3,3], scope='init_conv', normalizer_fn=slim.layers.batch_norm)
   ...
   net = slim.layers.conv2d(net, 64, [3,3], scope='conv_3_1', normalizer_fn=slim.layers.batch_norm)
