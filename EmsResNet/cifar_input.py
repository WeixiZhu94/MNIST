...
def build_input_cat_0(dataset, batch_size, mode):
  if mode == 'train':
    data_path = '../cifar10_cat_0/data_batch*'
  elif mode == 'test':
    data_path = '../cifar10_cat_0/test_batch.bin'
...
def build_input_cat_1(dataset, batch_size, mode):
  if mode == 'train':
    data_path = '../cifar10_cat_1/data_batch*'
  elif mode == 'test':
    data_path = '../cifar10_cat_1/test_batch.bin'
