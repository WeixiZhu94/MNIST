...
flags.DEFINE_string('log_dir', '../log/cifar10_ConvNet_v5_cat2/eval',
                    'Directory where to log data.')
flags.DEFINE_string('checkpoint_dir', '../log/cifar10_ConvNet_v5_cat2/train',
...
def main(train_dir, batch_size, num_batches, log_dir, checkpoint_dir=None):
    ...
    with tf.device('/cpu:0'):
      ...
      metrics_to_values, metrics_to_updates = slim.metrics.aggregate_metric_map({
          ...
          'streaming_mse': slim.metrics.streaming_mean_squared_error(predictions, labels_cat2),
      })
