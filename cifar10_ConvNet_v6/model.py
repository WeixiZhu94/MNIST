...
def attention(images):
   net = slim.layers.conv2d(images, 32, [3,3], scope='att_conv_0_0', normalizer_fn=slim.layers.batch_norm)

   net = slim.layers.conv2d(net, 32, [3,3], scope='att_conv_1_0', normalizer_fn=slim.layers.batch_norm)
   net = slim.layers.conv2d(net, 32, [3,3], scope='att_conv_1_1', normalizer_fn=slim.layers.batch_norm)
   net = slim.layers.max_pool2d(net, [2,2], scope='att_pool_1')

   net = slim.layers.conv2d(net, 128, [3,3], scope='att_conv_2_0', normalizer_fn=slim.layers.batch_norm)
   net = slim.layers.conv2d(net, 128, [3,3], scope='att_conv_2_1', normalizer_fn=slim.layers.batch_norm)
   net = slim.layers.max_pool2d(net, [2,2], scope='att_pool_2')

   net = slim.layers.conv2d(net, 512, [3,3], scope='att_conv_3_0', normalizer_fn=slim.layers.batch_norm)
   net = slim.layers.conv2d(net, 512, [3,3], scope='att_conv_3_1', normalizer_fn=slim.layers.batch_norm)
