...
def network(images, labels):
   ...
   hidden_4 = slim.layers.fully_connected(res, 128, scope='hidden_4', normalizer_fn=slim.layers.batch_norm)
   hidden_5 = slim.layers.fully_connected(hidden_4, 128, scope='hidden_5', normalizer_fn=slim.layers.batch_norm, activation_fn=None)
   res = tf.nn.relu(res+hidden_5)
