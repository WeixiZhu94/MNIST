...
def network(net, labels):
   ...
   net = slim.layers.conv2d(net, 100, [3,3], scope='conv_3_1', normalizer_fn=slim.layers.batch_norm)
   net = slim.layers.conv2d(net, 100, [3,3], scope='conv_3_2', normalizer_fn=slim.layers.batch_norm)
   net = slim.layers.conv2d(net, 100, [3,3], scope='conv_3_3', normalizer_fn=slim.layers.batch_norm)
   net = slim.layers.conv2d(net, 100, [3,3], scope='conv_3_4', normalizer_fn=slim.layers.batch_norm)
   net = slim.layers.conv2d(net, 100, [3,3], scope='conv_3_5', normalizer_fn=slim.layers.batch_norm)
   net = slim.layers.conv2d(net, 100, [3,3], scope='conv_3_6', normalizer_fn=slim.layers.batch_norm)
