...
def network(images, labels):
   ...
   net = slim.layers.conv2d(net, 16, [7,7], scope='conv_0_1', normalizer_fn=slim.layers.batch_norm)
   ...
   net = slim.layers.conv2d(net, 32, [7,7], scope='conv_2_1', normalizer_fn=slim.layers.batch_norm)
   ...
   net = slim.layers.conv2d(net, 64, [7,7], scope='conv_3_1', normalizer_fn=slim.layers.batch_norm)
